...
__contact_names__ = 'my_tensorlayer Contributors'
__contact_emails__ = 'my_tensorlayer@gmail.com'
__homepage__ = 'http://my_tensorlayer.readthedocs.io/en/latest/'
__repository_url__ = 'https://github.com/my_tensorlayer/my_tensorlayer'
__download_url__ = 'https://github.com/my_tensorlayer/my_tensorlayer'
